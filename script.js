...
const products = [
  {id:"classic", name:"Hotdog Clásico", category:"hotdogs", price:1.25, desc:"Salchicha, pan suave y nuestras salsas clásicas.", emoji:"🌭", image:"images/hotdog-clasico.jpg", featured:true, badge:"CLÁSICO"},
  {id:"special", name:"Hotdog Doble Salchicha", category:"hotdogs", price:1.50, desc:"Salchicha, toppings y salsas de la casa.", emoji:"🌭", image:"images/hotdog-doble.jpg", featured:true, badge:"MÁS VENDIDO"},
  {id:"combo-1", name:"Combo #1", image:"images/combo-1.jpg", category:"combos", price:2.00, desc:"Hotdog Clásico + soda.", emoji:"🍽️",featured:true, badge:"COMBO"},
  {id:"combo-2", name:"Combo #2", image:"images/combo-2.jpg", category:"combos", price:2.25, desc:"Hotdog Doble Salchicha + soda.", emoji:"🍽️", featured:true, badge:"COMBO"},
  {id:"combo-3", name:"Combo #3", image:"images/combo-3.jpg", category:"combos", price:2.50, desc:"Hotdog + papas + soda.", emoji:"🍽️",featured:true, badge:"COMBO"},
  {id:"combo-4", name:"Combo #4", image:"images/combo-4.jpg", category:"combos", price:3.00, desc:"Hotdog + papas con queso + soda.", emoji:"🍽️",featured:true, badge:"COMBO"},
  {id:"fries", name:"Papas Fritas", image:"images/papas.jpg", category:"papas", price:0.50, desc:"Papas crujientes, perfectas para acompañar.", emoji:"🍟",featured:true, badge:"PAPAS"},
  {id:"cheese-fries", name:"Papas con Queso", image:"images/papas-queso.jpg", category:"papas", price:1.00, desc:"Papas crujientes con queso cremoso.", emoji:"🧀",featured:true, badge:"PAPAS"},
  {id:"donuts", name:"Donas", image:"images/donas.jpg", category:"postre", price:1.00, desc:"Donas esponjosas y deliciosas.", emoji:"🍩",featured:true, badge:"POSTRE"},
  {id:"cookies", name:"Galletas", image:"images/galletas.jpg", category:"postre", price:0.50, desc:"Galletas crujientes y deliciosas.", emoji:"🍪",featured:true, badge:"POSTRE"},
  {id:"soda", name:"Soda", image:"images/soda.jpg", category:"bebidas", price:0.50, desc:"Elige tu sabor disponible en el punto de venta.", emoji:"🥤",featured:true, badge:"BEBIDA"},
];
...
function saveCart(){ localStorage.setItem("fullBiteCart", JSON.stringify(cart)); }
...
function productCard(p){
  return `<article class="product-card">
    ...
    <div class="product-visual">${p.image ? `<img src="${p.image}" alt="${p.name}" loading="lazy">` : p.emoji}</div>
...
function sendWhatsApp(){
  ...
  const message = `Hola, quiero realizar un pedido en FULL BITE.%0A%0A*Pedido:*%0A${lines.join("%0A")}%0A%0A*Total: ${money(cartTotal())}*%0A%0A¿Me confirman el pedido?`;
